      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Global Electric Services ofrece un conjunto completo de
            Servicios eléctricos en El Salvador, al servicio de la gente
            con soluciones profesionales entregadas por nuestros certificados
            y técnicos autorizados.
            <br/>
            Así es como nos diferenciamos de otros productos eléctricos
          ...
          <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.value} className="flex flex-col-reverse">
                ...
                <dd className="h-10 w-10 text-global-main-color hover:text-white">{<stat.icon />}</dd>
              </div>
            ))}
          </dl>
        </div>
